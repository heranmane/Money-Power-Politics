...
function fiteredby_party() {
  var party = dropdownMenu.property("value");
console.log(party)
...
// Ranking Data 
  ...
  // Getting Percentages for Combined 
  console.log(Avotes);
  var sumA = 0;
  ...
  createDonut(votePercentR, RfullName, 'Ranking Member %', 'Ranking', 'pieChairs');
  } else {    createDonut(votePercentA, AfullName, 'All Votes %', 'All Senators', 'pieChairs');
